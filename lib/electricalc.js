...
$hx_exports["electricalc"] = $hx_exports["electricalc"] || {};
...
$hxClasses["Type"] = Type;
Type.__name__ = "Type";
class electricalc_ElectricalCalculator {
	constructor(maglev) {
		this.maglev = maglev;
	...
	registerMyMethods() {
		let bus = this.maglev;
		this.maglev.register("ElectricalCalculator.ConvertPhaseAngleToPowerFactor",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ElectricalCalculator.ConvertPhaseAngleToPowerFactor"));
			data.push(maglev_MagLevString.fromString("electricalc"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ElectricalCalculator.ConvertPhaseAngleToPowerFactor' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ElectricalCalculator.ConvertPowerFactorToPhaseAngle",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ElectricalCalculator.ConvertPowerFactorToPhaseAngle"));
			data.push(maglev_MagLevString.fromString("electricalc"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ElectricalCalculator.ConvertPowerFactorToPhaseAngle' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ElectricalCalculator.CalculateSinglePhasePower",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ElectricalCalculator.CalculateSinglePhasePower"));
			data.push(maglev_MagLevString.fromString("electricalc"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ElectricalCalculator.CalculateSinglePhasePower' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ElectricalCalculator.CalculateThreePhasePower",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ElectricalCalculator.CalculateThreePhasePower"));
			data.push(maglev_MagLevString.fromString("electricalc"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ElectricalCalculator.CalculateThreePhasePower' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
	}
}
$hxClasses["electricalc.ElectricalCalculator"] = $hx_exports["electricalc"]["ElectricalCalculator"] = electricalc_ElectricalCalculator;
electricalc_ElectricalCalculator.__name__ = "electricalc.ElectricalCalculator";
Object.assign(electricalc_ElectricalCalculator.prototype, {
	__class__: electricalc_ElectricalCalculator
	,maglev: null
});
...
var electricalc = $hx_exports["electricalc"];
